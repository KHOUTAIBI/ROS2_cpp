...
#include <stddef.h>
#include "cpp_interfaces/msg/detail/stm_control__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  cpp_interfaces__msg__STMControl__init(message_memory);
}

void STMControl__rosidl_typesupport_introspection_c__STMControl_fini_function(void * message_memory)
{
  cpp_interfaces__msg__STMControl__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember STMControl__rosidl_typesupport_introspection_c__STMControl_message_member_array[5] = {
  {
    ...
    offsetof(cpp_interfaces__msg__STMControl, header),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces__msg__STMControl, control_type),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces__msg__STMControl, setpoint),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces__msg__STMControl, kp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces__msg__STMControl, pwm),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers STMControl__rosidl_typesupport_introspection_c__STMControl_message_members = {
  ...
  5,  // number of fields
  sizeof(cpp_interfaces__msg__STMControl),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, cpp_interfaces, msg, STMControl)() {
