...
#ifndef CPP_INTERFACES__MSG__DETAIL__STM_STATE__STRUCT_HPP_
#define CPP_INTERFACES__MSG__DETAIL__STM_STATE__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__cpp_interfaces__msg__STMState __attribute__((deprecated))
#else
# define DEPRECATED__cpp_interfaces__msg__STMState __declspec(deprecated)
#endif
...
struct STMState_
{
  ...
  // pointer types
  using RawPtr =
    cpp_interfaces::msg::STMState_<ContainerAllocator> *;
  using ConstRawPtr =
    const cpp_interfaces::msg::STMState_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      cpp_interfaces::msg::STMState_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__cpp_interfaces__msg__STMState
    std::shared_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__cpp_interfaces__msg__STMState
    std::shared_ptr<cpp_interfaces::msg::STMState_<ContainerAllocator> const>
...
using STMState =
  cpp_interfaces::msg::STMState_<std::allocator<void>>;
...
#endif  // CPP_INTERFACES__MSG__DETAIL__STM_STATE__STRUCT_HPP_
