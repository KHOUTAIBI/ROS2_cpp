...
{
  new (message_memory) cpp_interfaces::msg::STMControl(_init);
}

void STMControl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<cpp_interfaces::msg::STMControl *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember STMControl_message_member_array[5] = {
  {
    ...
    offsetof(cpp_interfaces::msg::STMControl, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces::msg::STMControl, control_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces::msg::STMControl, setpoint),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces::msg::STMControl, kp),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(cpp_interfaces::msg::STMControl, pwm),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers STMControl_message_members = {
  ...
  5,  // number of fields
  sizeof(cpp_interfaces::msg::STMControl),
...
get_message_type_support_handle<cpp_interfaces::msg::STMControl>()
{
  return &::cpp_interfaces::msg::rosidl_typesupport_introspection_cpp::STMControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, cpp_interfaces, msg, STMControl)() {
  return &::cpp_interfaces::msg::rosidl_typesupport_introspection_cpp::STMControl_message_type_support_handle;
}
